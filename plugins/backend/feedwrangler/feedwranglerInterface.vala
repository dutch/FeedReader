...
public class FeedReader.feedwranglerInterface : Peas.ExtensionBase, FeedServerInterface {
	...
	{
		return "feed-service-feedwrangler-symbolic";
	}
...
public void peas_register_types(GLib.TypeModule module)
{
	...
	objmodule.register_extension_type(typeof(FeedReader.FeedServerInterface), typeof(FeedReader.feedwranglerInterface));
}
